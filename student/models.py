...
class Applicant(models.Model):
    ...
    second_name_ar = models.CharField(max_length=255, blank=True, null=True)
    third_name_ar = models.CharField(max_length=255, blank=True, null=True)
...
class ApplicantPreviousSchoolData(models.Model):
    applicant_id = models.ForeignKey(Applicant,on_delete=models.DO_NOTHING)
    last_attended_school = models.CharField(max_length=255, blank=True, null=True)
    last_attended_school_ar = models.CharField(max_length=255, blank=True, null=True)
